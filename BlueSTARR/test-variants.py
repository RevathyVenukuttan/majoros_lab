...
#
#========================================================================
# Modified on 12/15/2025 - Revathy 
# Added output directory to save the scores file
#========================================================================
...
#                                main()
#=========================================================================
def main(infile,modelFilestem,output_dir):
    #startTime=time.time()
...
#=========================================================================
if(len(sys.argv)!=4):
    exit(ProgramName.get()+" <model-filestem> <data> <output-dir>\n")
(modelFilestem,infile,output_dir)=sys.argv[1:]
main(infile,modelFilestem,output_dir)
