...
TWO_BIT_TO_FA="/hpc/home/rv103/igvf/revathy/software/twoBitToFa"
TWO_BIT="/hpc/group/igvf/A549/extra_GCs/hg38.2bit"
# TWO_BIT="/hpc/home/rv103/igvf/revathy/ref_data/dm3.2bit"
CHILD="/hpc/home/rv103/igvf/revathy/BlueSTARR/mutator-child.py"
    ...
    while(True):
        ...
        for Pos in positions:
            ...
            for allele in alleles:
                ...
                if(seq[local]!=ref):
                    print(f"[DEBUG] CRE ID: {cre.ID}, Position: {pos}, Seq Base: {seq[local]}, Ref Base: {ref}")
